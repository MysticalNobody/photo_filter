...
class _PhotoFilterSelectorState extends State<PhotoFilterSelector> {
      ...
      body: SafeArea(
        child: NestedScrollView(
          ...
          headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
            return <Widget>[
              PFAppbar(
                title: 'Your photo'.i18n,
                toolbarHeight: toolbarHeight,
                leftPadding: leftPadding,
                withBack: true,
                onDone: () =>
                    saveFilteredImage().then((value) => Navigator.pop(context)),
              )
            ];
          },
          body: Container(
        ...
        builder: (BuildContext context, AsyncSnapshot<List<int>> snapshot) {
          switch (snapshot.connectionState) {
            ...
            case ConnectionState.done:
              ...
              return Container(width: 50, child: Image.memory(snapshot.data));
          }
          return null; // unreachable
        },
      );
  ...
  Future<File> saveFilteredImage() async {
    ...
    PhotoProvider().save(imageFile.path);
    return imageFile;
  }
